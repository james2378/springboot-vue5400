		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','activity_time') || $check_field('add','activity_time') || $check_field('set','activity_time')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="活动时间" prop="activity_time">
					<el-date-picker :disabled="disabledObj['activity_time_isDisabled']" v-if="user_group === '管理员' || (form['registration_record_id'] && $check_field('set','activity_time')) || (!form['registration_record_id'] && $check_field('add','activity_time'))" id="activity_time"
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','student_information') || $check_field('add','student_information') || $check_field('set','student_information')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="学生信息" prop="student_information">
						<div v-if="user_group !== '管理员'">
							...
							<!--v-if="user_group === '管理员' || (form['registration_record_id'] && $check_field('set','student_information')) || (!form['registration_record_id'] && $check_field('add','student_information'))" :disabled="disabledObj['student_information_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','student_information')">{{form['student_information']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['registration_record_id'] && $check_field('set','student_information')) || (!form['registration_record_id'] && $check_field('add','student_information'))" id="student_information" v-model="form['student_information']" :disabled="disabledObj['student_information_isDisabled']">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','student_name') || $check_field('add','student_name') || $check_field('set','student_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="学生姓名" prop="student_name">
					<el-input id="student_name" v-model="form['student_name']" placeholder="请输入学生姓名"
							  v-if="user_group === '管理员' || (form['registration_record_id'] && $check_field('set','student_name')) || (!form['registration_record_id'] && $check_field('add','student_name'))" :disabled="disabledObj['student_name_isDisabled']"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','student_number') || $check_field('add','student_number') || $check_field('set','student_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="学生学号" prop="student_number">
					<el-input id="student_number" v-model="form['student_number']" placeholder="请输入学生学号"
							  v-if="user_group === '管理员' || (form['registration_record_id'] && $check_field('set','student_number')) || (!form['registration_record_id'] && $check_field('add','student_number'))" :disabled="disabledObj['student_number_isDisabled']"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','contact_number') || $check_field('add','contact_number') || $check_field('set','contact_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="联系电话" prop="contact_number">
					<el-input id="contact_number" v-model="form['contact_number']" placeholder="请输入联系电话" type="tel"
						v-if="user_group === '管理员' || (form['registration_record_id'] && $check_field('set','contact_number')) || (!form['registration_record_id'] && $check_field('add','contact_number'))">
					</el-input>
					<div v-else-if="$check_field('get','contact_number')">{{form['contact_number']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','registration_status') || $check_field('add','registration_status') || $check_field('set','registration_status')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="报名状态" prop="registration_status">
					<el-select id="registration_status" v-model="form['registration_status']"
						v-if="user_group === '管理员' || (form['registration_record_id'] && $check_field('set','registration_status')) || (!form['registration_record_id'] && $check_field('add','registration_status'))">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','participation_status') || $check_field('add','participation_status') || $check_field('set','participation_status')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="参加状态" prop="participation_status">
					<el-select id="participation_status" v-model="form['participation_status']"
						v-if="user_group === '管理员' || (form['registration_record_id'] && $check_field('set','participation_status')) || (!form['registration_record_id'] && $check_field('add','participation_status'))">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','registration_reply') || $check_field('add','registration_reply') || $check_field('set','registration_reply')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="报名回复" prop="registration_reply">
					<el-input type="textarea" id="registration_reply" v-model="form['registration_reply']" placeholder="请输入报名回复"
						v-if="user_group === '管理员' || (form['registration_record_id'] && $check_field('set','registration_reply')) || (!form['registration_record_id'] && $check_field('add','registration_reply'))" :disabled="disabledObj['registration_reply_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','registration_reply')">{{form['registration_reply']}}</div>
				</el-form-item>
			</el-col>
