<template>
	<div class="diy_details_box diy_div_school_labor">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
						...
						<!-- 图片 -->
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/participation_record/edit','add')" @click="to_form('/participation_record/edit')" >参加 </button>
							</div>
						<!-- 富文本 -->
