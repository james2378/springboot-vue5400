		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','registration_reply')">报名回复
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_text" v-if="$check_field('get','registration_reply')">
						<span>
							{{ o["registration_reply"] }}
						</span>
					</td>
				</tr>
			</table>
