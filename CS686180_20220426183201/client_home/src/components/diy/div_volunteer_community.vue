<template>
	<div class="diy_details_box diy_div_volunteer_community">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
						...
						<!-- 图片 -->
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/group_record/edit','add')" @click="to_form('/group_record/edit')" >加入 </button>
							</div>
						<!-- 富文本 -->
