						...
						<div class="card">
							...
							<div class="form_register">
								<b-form>
									...
									<!--学生用户-->
									<form_student_user v-if="form.user_group === '学生用户'" :form="form_sub"></form_student_user>
...
<script>
	...
	/* 学生用户 */
	import form_student_user from "@/components/diy/form_student_user";
				...
				if(!ret && user_group){
					if(user_group === "学生用户"){
						...
						if(!ret && !form_sub["student_number"]){
							...
							res = await this.$get("~/api/student_user/count?", {"student_number": form_sub["student_number"]});
							if(res.result){
								ret = "学生学号已存在!";
							}
						}
